...
const openAuditTrail = (letterNumber) => {
    auditTarget.value = letterNumber;
...
<template>
    ...
    <AuthenticatedLayout>
                                ...
                                <tr v-for="(letter, index) in items" :key="letter.id" class="hover:bg-slate-50/80 transition group">
                                    ...
                                    <td class="border border-gray-800 px-4 py-3 text-center">
                                        <div class="flex justify-center gap-3">
                                            <button @click="openAuditTrail(letter.letter_number)" class="text-gray-400 hover:text-blue-600" title="Jejak Audit & Riwayat">
        ...
        <AuditTrailModal :show="showAuditModal" :target="auditTarget" title="Jejak Audit Arsip Surat" @close="showAuditModal = false" />
    </AuthenticatedLayout>
</template>
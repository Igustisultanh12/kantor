...
<html>
<head>
    <title>LAPORAN REKENING IBU BETI</title>
    <style>
        body {
...
<body>
    ...
    <div class="title">
        <h3>DAFTAR MUTASI DAN ALOKASI DANA REKENING IBU BETI</h3>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 45%;">KETERANGAN MUTASI</th>
                <th style="width: 17%;">DEBET (MASUK)</th>
        ...
        <tbody>
            ...
            @forelse($logs as $log)
                <tr>
                    ...
                    <td style="text-transform: uppercase;">
                        ...
                        <span style="font-size: 8px; color: #555;">Petugas: {{ $log->petugas_input ?? '-' }}</span>
                    </td>
            ...
            @empty
                <tr>
                    <td colspan="5" class="text-center" style="padding: 20px; font-style: italic; color: #777;">
            ...
            <tr style="background-color: #f9f9f9; font-weight: bold;">
                <td colspan="3" class="text-right uppercase">TOTAL REKAPITULASI ARUS DANA:</td>
            ...
            <tr style="background-color: #f2f2f2; font-weight: bold; font-size: 12px;">
                <td colspan="3" class="text-right uppercase">SALDO AKHIR REKENING IBU BETI:</td>

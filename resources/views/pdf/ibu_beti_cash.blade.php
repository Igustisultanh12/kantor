...
<head>
    <meta charset="UTF-8">
    <title>REKENING KORAN - REKENING IBU BETI - {{ $periodLabel ?? date('Y') }}</title>
    <style>
        @page {
        ...
        .text-saldo { color: #db2777; font-weight: bold; }
...
<body>
    ...
    <table class="kop-table">
        <tr>
            ...
            <td class="kop-right">
                ...
                <div class="statement-subtitle">BANK ACCOUNT STATEMENT &bull; REKENING IBU BETI</div>
            </td>
        </tr>
    </table>
    ...
    <table class="info-card">
        <tr>
            ...
            <td class="info-value">{{ $accountHolder ?? 'REKENING IBU BETI' }}</td>
            <td class="info-label">Periode Mutasi</td>
            <td class="info-value" style="color: #db2777;">{{ $periodDates ?? $periodLabel }}</td>
        </tr>
        <tr>
            <td class="info-label">Nomor Rekening</td>
            <td class="info-value font-mono">{{ $accountNo ?? 'SINDEN-BETI-02' }}</td>
            <td class="info-label">Mata Uang</td>
            <td class="info-value">IDR (Indonesian Rupiah)</td>
        </tr>
        <tr>
            <td class="info-label">Jenis Pembukuan</td>
            <td class="info-value">Kas Khusus Ibu Beti</td>
        ...
        <tbody>
            <tr>
                ...
                <td class="summary-data-cell summary-data-ending">
                    ...
                    <span class="summary-subtext" style="color: #be185d; font-weight: bold;">Sisa kas tersedia</span>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="ledger-table">
        ...
        <tbody>
            ...
            <tr class="total-row">
                ...
                <td class="text-right font-mono text-saldo" style="font-size: 10px; background-color: #fce7f3;">
                    Rp {{ number_format($saldoAkhir ?? 0, 0, ',', '.') }}
                </td>
            </tr>
        </tbody>
        ...
        <tr>
            <td style="width: 58%; padding-right: 15px;">
                <div class="notice-box">
                    ...
                    2. Seluruh pencatatan arus dana keluar dan masuk diverifikasi secara real-time berdasarkan pembukuan kas Ibu Beti.<br>
            ...
            <td style="width: 42%;">
                <div class="sign-box">
                    ...
                    <p style="margin: 0; color: #475569;">Petugas Pengelola Rekening,</p>

...
Route::middleware('auth')->group(function () {
    ...
    // Modul Pelanggaran Disiplin Prajurit
    ...
    Route::post('/soldier-violations/{id}', [SoldierViolationController::class, 'update'])->name('soldier-violations.update');
    ...
    Route::middleware(['role:admin'])->group(function () {
        ...
        // =====================================================================
        // Mengarahkan langsung ke fungsi kontroler PESSAdminController yang sudah dilengkapi
